...
exports.AppSettingEntity = void 0;
const openapi = require("@nestjs/swagger");
const typeorm_1 = require("typeorm");
const table_name_enum_1 = require("./enums/table-name.enum");
let AppSettingEntity = class AppSettingEntity {
    static _OPENAPI_METADATA_FACTORY() {
        return { key: { required: true, type: () => String }, value: { required: false, type: () => String }, updatedAt: { required: false, type: () => String } };
    }
};
...
exports.AppSettingEntity = AppSettingEntity = __decorate([
    (0, typeorm_1.Entity)(table_name_enum_1.TableNameEnum.APP_SETTINGS)
], AppSettingEntity);
