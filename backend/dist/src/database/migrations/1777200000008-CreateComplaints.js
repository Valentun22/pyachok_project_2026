...
exports.CreateComplaints1777200000008 = void 0;
class CreateComplaints1777200000008 {
    constructor() {
        this.name = 'CreateComplaints1777200000008';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TYPE "complaints_type_enum" AS ENUM ('venue', 'news', 'comment', 'other')`);
        await queryRunner.query(`CREATE TYPE "complaints_status_enum" AS ENUM ('new', 'in_review', 'resolved', 'rejected')`);
...
exports.CreateComplaints1777200000008 = CreateComplaints1777200000008;
//# sourceMappingURL=1777200000008-CreateComplaints.js.map