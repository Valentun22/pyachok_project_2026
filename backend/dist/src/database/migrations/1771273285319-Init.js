...
exports.Init1771273285319 = void 0;
class Init1771273285319 {
    constructor() {
        this.name = 'Init1771273285319';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "venues_tags_tags" ("venuesId" uuid NOT NULL, "tagsId" uuid NOT NULL, CONSTRAINT "PK_9e932bf228e400602f2f8e2986b" PRIMARY KEY ("venuesId", "tagsId"))`);
...
exports.Init1771273285319 = Init1771273285319;
//# sourceMappingURL=1771273285319-Init.js.map