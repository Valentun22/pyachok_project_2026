...
exports.CreatePyachokRequests1777700000013 = void 0;
class CreatePyachokRequests1777700000013 {
    constructor() {
        this.name = 'CreatePyachokRequests1777700000013';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TYPE "pyachok_request_status_enum" AS ENUM ('open', 'closed')`);
        await queryRunner.query(`CREATE TYPE "pyachok_request_genderpreference_enum" AS ENUM ('any', 'male', 'female')`);
        await queryRunner.query(`CREATE TYPE "pyachok_request_payer_enum" AS ENUM ('any', 'me', 'split', 'other')`);
...
exports.CreatePyachokRequests1777700000013 = CreatePyachokRequests1777700000013;
//# sourceMappingURL=1777700000013-CreatePyachokRequests.js.map