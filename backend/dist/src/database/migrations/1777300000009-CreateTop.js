...
exports.CreateTop1777300000009 = void 0;
class CreateTop1777300000009 {
    constructor() {
        this.name = 'CreateTop1777300000009';
    }
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_top_category_venues_category_id" ON "top_category_venues" ("category_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_top_category_venues_venue_id" ON "top_category_venues" ("venue_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_top_category_venues_order" ON "top_category_venues" ("order")`);
    }
...
exports.CreateTop1777300000009 = CreateTop1777300000009;
//# sourceMappingURL=1777300000009-CreateTop.js.map