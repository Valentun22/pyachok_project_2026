...
export class CreateSuperadmin1778000000017 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (!email || !password) {
            console.warn(
                '[Migration] ADMIN_EMAIL або ADMIN_PASSWORD не задані — суперадміна не створено.',
            );
            return;
        }
       ...
       VALUES ($1, $2, $3, ARRAY['superadmin']::users_role_enum[], true)`,
